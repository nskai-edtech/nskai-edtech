...
// Trigger Next.js dev server hard reload
    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' https://*.clerk.com https://*.sentry.io https://challenges.cloudflare.com https://va.vercel-scripts.com",
