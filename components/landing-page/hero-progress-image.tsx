...
function HeroProgressImage() {
  return (
    <div className="bg-gray-200 dark:bg-surface w-full h-auto min-h-[350px] md:h-[480px] px-4 md:px-8 py-8 flex flex-col justify-end rounded-2xl">
      <div className="flex flex-col gap-6 bg-white dark:bg-surface-muted p-4 rounded-lg">
        ...
        {/* progress bar */}
        <div>
            <div className="w-full bg-gray-200 rounded-full h-6 dark:bg-surface">
            <div
